...
## Constants
CODE_DIRECTORY = 'graphite_api_rackspace'
DOCS_DIRECTORY = 'docs'
...
#
# However, when we do this, we also import `graphite_api_rackspace/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'graphite_api_rackspace_cli = graphite_api_rackspace.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'graphite_api_rackspace_gui = graphite_api_rackspace.gui:entry_point'
        # ]
    }
)
